...
A machine learning pipeline that automatically classifies scientific paper abstracts into research categories — **Artificial Intelligence**, **Machine Learning**, and **Computational Neuroscience** — using NLP techniques and classical ML models.
